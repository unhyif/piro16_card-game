...
>>>>>>> 3ea053c425f2ab6dcb0cc0810b816d632eb0c0fc
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
<<<<<<< HEAD
                ('attacker_num', models.IntegerField(blank=True, choices=[(2, 2), (3, 3), (4, 4), (5, 5), (9, 9)], verbose_name='공격자 선택')),
                ('defender_num', models.IntegerField(blank=True, choices=[(1, 1), (3, 3), (6, 6), (7, 7), (9, 9)], null=True, verbose_name='수비자 선택')),
=======
