...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attacker_num', models.IntegerField(blank=True, choices=[(3, 3), (5, 5), (6, 6), (9, 9), (10, 10)], verbose_name='공격자 선택')),
                ('defender_num', models.IntegerField(blank=True, choices=[(1, 1), (2, 2), (5, 5), (9, 9), (10, 10)], null=True, verbose_name='수비자 선택')),
