...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attacker_num', models.IntegerField(blank=True, choices=[(3, 3), (6, 6), (7, 7), (9, 9), (10, 10)], verbose_name='공격자 선택')),
                ('defender_num', models.IntegerField(blank=True, choices=[(2, 2), (3, 3), (4, 4), (7, 7), (8, 8)], null=True, verbose_name='수비자 선택')),
